...
const Hero = () => {
  return (
    <div className="grid lg:grid-cols-2 gap-24 items-center">
      ...
      <div className="hidden h-[28rem] lg:carousel carousel-center p-4 space-x-4 bg-primary-content rounded-box sm:carousel carousel-center p-4 space-x-4 bg-secondary-content rounded-box">
        {carouselImg.map((img) => {
          return (
